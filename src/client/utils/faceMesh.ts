...
export function updateGeometry(BufferGeometry: THREE.BufferGeometry, attribute: THREE.BufferAttribute, name:string){
...
function getVectorsFromBufferArray(indexes: number[], Attribute: THREE.BufferAttribute | THREE.InterleavedBufferAttribute, z: number){
  let vectorArray: THREE.Vector3[] = []
...
export function updatePlaneBuffer(center: number, positions: THREE.BufferAttribute | THREE.InterleavedBufferAttribute, updateGeometry: THREE.BufferGeometry){
